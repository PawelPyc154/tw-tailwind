...
describe("tw", async () => {
  it("should render component with className", () => {
    ...
    expect(screen.getByTestId("Component-1")).toHaveClass(
      "bg-red-600 text-red-300",
    );
    expect(screen.getByTestId("Component-2")).toHaveClass(
      "bg-red-600 text-red-300",
    );
    expect(screen.getByTestId("Component-3")).toHaveClass(
      "bg-red-600 text-red-300",
    );
    expect(screen.getByTestId("Component-4")).toHaveClass(
      "bg-red-600 text-red-300",
    );
    expect(screen.getByTestId("Component-5")).toHaveClass(
      "bg-red-600 text-red-300",
    );
    expect(screen.getByTestId("Component-6")).toHaveClass(
      "bg-red-600 text-red-300",
    );
  });
  ...
  it("should render component with props attributes and className", () => {
    ...
    render(
      <>
        ...
        <Component3
          disabled
          data-testid="Component-3"
          className="text-red-300"
        />
        <Component4
          disabled
          data-testid="Component-4"
          className="text-red-300"
        />
        <Component5
          disabled
          data-testid="Component-5"
          className="text-red-300"
        />
        <Component6
          disabled
          data-testid="Component-6"
          className="text-red-300"
        />
      </>,
    );
  ...
  it("should ignore falsy value", () => {
    ...
    expect(screen.getByTestId("Component-1")).not.toHaveClass(
      "null undefined false",
    );
    expect(screen.getByTestId("Component-2")).not.toHaveClass(
      "null undefined false",
    );
    expect(screen.getByTestId("Component-3")).not.toHaveClass(
      "null undefined false",
    );
    expect(screen.getByTestId("Component-4")).not.toHaveClass(
      "null undefined false",
    );
    expect(screen.getByTestId("Component-5")).not.toHaveClass(
      "null undefined false",
    );
    expect(screen.getByTestId("Component-6")).not.toHaveClass(
      "null undefined false",
    );
  });
